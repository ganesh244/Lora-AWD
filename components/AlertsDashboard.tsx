...
import { Droplets, CloudRain, Wind, Bug, Leaf, AlertTriangle, CheckCircle2, Thermometer, ArrowRight, Bell, Check, RotateCcw, ClipboardList, Filter, ChevronDown, ChevronUp, CheckSquare, List } from 'lucide-react';
